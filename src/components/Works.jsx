      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            ...
            >
              <img
                src={hasGithub ? github : externalLink}
                alt="source code"
        ...
        <div className="mt-5">
          <h3 className="text-[#FBE8DA] font-bold text-[24px]">{name}</h3>
    ...
    <>
      ...
      <div className="w-full flex">
        <motion.p
          ...
          className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px] font-medium"
        >
