...
const ServiceCard = ({ index, title, icon }) => {
  return (
    <Tilt tiltReverse className="xs:w-[250px] w-full">
      <motion.div
        variants={fadeIn("right", "spring", 0.5 * index, 0.75)}
        className="w-full bg-gradient-to-b from-secondary to-primary p-[1px] rounded-[20px] shadow-card"
      >
        <div
        ...
        >
          <img
            ...
            style={{
              filter:
                "invert(86%) sepia(1%) saturate(7411%) hue-rotate(334deg) brightness(110%) contrast(87%)",
            }}
          />
          <h3 className="text-[#FBE8DA] text-[20px] font-bold text-center">
            {title}
          </h3>
        </div>
      </motion.div>
